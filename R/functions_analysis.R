...
#' @param n.thin numeric: Thinning rate
#' @return A rjags object
fit_mortality_full_sub2 <- function(data_jags.in, n.chains, n.iter, n.burn, n.thin){
...
#' @param n.thin numeric: Thinning rate
#' @return A rjags object
fit_mortality_full_sub2_parallel <- function(data_jags.in, n.chains, n.iter, n.burn, n.thin){
